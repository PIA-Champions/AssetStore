...
class TestAsset_pack_DAO:
    ...
    def test_purchase_asset_pack(self,user_id,asset_pack_id)
        ...
        purchase.purchase(user_id,asset_pack_id)
    ...
    def test_list_purchased(self,user_id):
        ...
        purchase = purchase_controller.Purchase_Controller()        
        purchase.purchase(user_id,asset_pack_id_1)
        purchase.purchase(user_id,asset_pack_id_2)

        purchased_list = purchase.get_purchased(user_id)
